...
//go:generate minimock -i github.com/ArtEmerged/o_chat-server/internal/client/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/ArtEmerged/o_chat-server/internal/client/db"
